package FirstStudyProgramm.EncapsulationLesson.Lesson19builder;
...
public class Test1SB {
    public static void main(String[] args) {
        ...
        sb2.append(new Car());
        System.out.println(sb2);//Good Day!!todayGood Day!!today  "FirstStudyProgramm.FirstStudyProgramm.EncapsulationLesson.EncapsulationLesson.Lesson19builder.Car@43a25848"-обьект класса Car(новый)
