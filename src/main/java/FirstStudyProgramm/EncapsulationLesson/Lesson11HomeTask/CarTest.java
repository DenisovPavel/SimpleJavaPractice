...
//        До использования метода, кол-во дверей машины: 4
//        После использования метода, кол-во дверей машины: 2

//        До использования метода, кол-во дверей машины: 3
//        После использования метода, кол-во дверей машины: 4

//        До использования метода, цвет  машины: Blue мотор машины: V6 кол-во дверей: 4
//        После использования метода, цвет  машины: Blue мотор машины: V6 кол-во дверей: 4
//        До использования метода, цвет  машины: White мотор машины: V8 кол-во дверей: 3
//        После использования метода, цвет  машины: Blue мотор машины: V8 кол-во дверей: 3
    }
}
